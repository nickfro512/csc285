...
public:
	...
	vector<int> searchOneField(string term, int field)
	{
...
public:
	...
	vector<int> searchMediaOneField(string search_term, int field)
	{
		theMediaList.searchOneField(search_term, field);
	}
